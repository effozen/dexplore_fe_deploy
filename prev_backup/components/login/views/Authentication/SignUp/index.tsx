...
export default function SignUp() {
    ...
    // 체크박스의 상태를 관리하는 state, 기본값은 'ROLE_USER'
    ...
    const handleCheckboxChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        // 체크박스의 체크 상태에 따라 role 상태를 변경
        setRole( event.target.checked ? 'ROLE_ADMIN' : 'ROLE_USER' );
    };
    ...
    const onSignUpButtonClickHandler = () => {
        ...
        const requestBody: SignUpRequestDto = { id, password, email, certificationNumber, role };
                    ...
                    <div className='sign-up-content-box'>
                        ...
                        <div className='sign-up-content-input-box'>
                            ...
                            <InputBox ref={emailRef} title='이메일' placeholder='이메일 주소를 입력해주세요' type='text' value={email}
                                      isErrorMessage={isEmailError} onChange={onEmailChangeHandler}
                                      message={emailMessage} buttonTitle='이메일 인증'
                                      onButtonClick={onEmailButtonClickHandler} onKeydown={onEmailKeyDownHandler}/>
                            <InputBox ref={certificationNumberRef} title='인증번호' placeholder='인증번호 6자리를 입력해주세요'
                            ...
                            <div className='inputBox'>
                                ...
                                <span className='input-box-title'>관리자 인가요? : </span>
                                <input className='input-box-checkBox' ref={roleRef} title='관리자'
                                       type="checkbox"
                        ...
                        <div className='sign-up-content-button-box'>
                            ...
                            <div className='secondary-button-lg full-width' onClick={onSignInButtonClickHandler}>{'로그인'}</div>
                        </div>
                    </div>
                </div>
            </div>
