...
const AdminManagement = () => {
  ...
  return (
    <div className='flex flex-col'>
      ...
      <ContentCarousel name={dataList.title2} itemInfo={artList} isAdmin={false} isMuseum={false} museumSelector={<SelectList selectItems={museumList} setChosenMuseum={setChosenMuseum}/>}/>
    </div>
  );
}
